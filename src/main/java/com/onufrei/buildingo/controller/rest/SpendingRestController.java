...
import com.onufrei.buildingo.forms.SpendingForm;
...
public class SpendingRestController {
	...
	private SpendingRestController(@Autowired SpendingService service, @Autowired BuildingService buildingService) {
	...
	private Spending addSpending(@ApiParam(name = "Spending", value = "The json of spending you want to add. "
			+ "Id, createdAt and modifiedAt dates generate automatically") @RequestBody SpendingForm spendingForm) {
		return service.add(spendingForm.toSpendingEntity(buildingService));
	}
	...
	private Spending updateSpending(@ApiParam(name = "Spending", value = "The json of customer you want to update. "
			+ "The id of spending you pass must correspond to spending's id you want to update") @RequestBody SpendingForm spendingForm) {
		return service.update(spendingForm.toSpendingEntity(buildingService));
	}
